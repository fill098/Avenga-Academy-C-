...
public class Driver : BaseEntity
{
    ...
    public Driver(string firstName, string lastName, Shift shift, Car car, string licinse, DateTime licensePlateExpieryDate)
    {
        FirstName = firstName;
        LastName = lastName;
        Shift = shift;
        Car = car;
        License = licinse;
        LicenseExpieryDate = licensePlateExpieryDate;
    }
